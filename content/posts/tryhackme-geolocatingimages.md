...
date: 2024-09-14T13:00:00+03:00
categories: [TryHackMe, OSINT]
series: [TryHackMe]
tags: [TryHackMe, Write-up, OSINT]
---
...
![Image 1](/posts/tryhackme-geolocatingimages/1.jpeg "Image 1")
...
![Google Reverse Image Search - Image 1](/posts/tryhackme-geolocatingimages/image_1_google_rev_img_search.png "Google Reverse Image Search - Image 1")
...
![Yandex Reverse Image Search - Image 1](/posts/tryhackme-geolocatingimages/image_1_yandex_rev_img_search.png "Yandex Reverse Image Search - Image 1")
...
![Task 3 description - Image 1](/posts/tryhackme-geolocatingimages/task_3_description_image_1.png)
...
![Task 3 description - Image 2](/posts/tryhackme-geolocatingimages/task_3_description_image_2.png)
...
![Task 3 description - Image 3](/posts/tryhackme-geolocatingimages/task_3_description_image_3.png)
...
![Task 3 description - Image 4](/posts/tryhackme-geolocatingimages/task_3_description_image_4.png)

So Google maps hasn't updated yet.

If we turn the camera around on Google maps, we can see where the live webcam should be.

![Task 3 description - Image 5](/posts/tryhackme-geolocatingimages/task_3_description_image_5.png)
...
![Image 2](/posts/tryhackme-geolocatingimages/2.png "Image 2")

This looks like a camera feed. Let's take note of the visible text:
- N SHEFFIELD AV 

![North Sheffield Avenue](/posts/tryhackme-geolocatingimages/n_sheffield_av.png "North Sheffield Avenue")

- W ADDISON ST 

![West Addison Street](/posts/tryhackme-geolocatingimages/w_addison_st.png "West Addison Street")

- SPORTS CORNER

![Sports Corner](/posts/tryhackme-geolocatingimages/sports_corner.png "Sports Corner")
...
![Street View: The Sports Corner in Chicago, United States](/posts/tryhackme-geolocatingimages/sports_corner_street_view.png "Street View: The Sports Corner in Chicago, United States")
...
![Image 3](/posts/tryhackme-geolocatingimages/3.png "Image 3")
...
![Image 3 Tower](/posts/tryhackme-geolocatingimages/image-3-tower.png "Image 3 Tower")

- River

![Image 3 River](/posts/tryhackme-geolocatingimages/image-3-river.png "Image 3 River")

- Building with a dome roof

![Image 3 Building](/posts/tryhackme-geolocatingimages/image-3-building.png "Image 3 Building")
...
![Google - Tower](/posts/tryhackme-geolocatingimages/google-tower.png "Google: Tower")

Let's compare Paris satellite view with the image:

![Paris and Image 3 comparison](/posts/tryhackme-geolocatingimages/paris-image-3-comparison.png "Paris and Image 3 comparison")
...
![Google Earth Paris 3D View](/posts/tryhackme-geolocatingimages/google-earth-paris-3d.png "Google Earth Paris 3D View")

Then I decided to move back until I saw a hill and got here:

![Google Earth Paris 3D View](/posts/tryhackme-geolocatingimages/google-earth-paris-3d-2.png "Google Earth Paris 3D View")
...
![Image 4](/posts/tryhackme-geolocatingimages/4.png "Image 4")
...
![Image 4 statue](/posts/tryhackme-geolocatingimages/image-4-statue.png "Image 4 Statue")
...
![London Cab](/posts/tryhackme-geolocatingimages/london-cab.png "London Cab")

I searched for "London 3-way intersection" in DuckDuckGo Images (my default search engine) and found this gem:

![DuckDuckGo Search](/posts/tryhackme-geolocatingimages/ddg-search.png "DuckDuckGo Search")
...
![Edward Onslow Ford monument](/posts/tryhackme-geolocatingimages/onslow-monument-street-view.png "Edward Onslow Ford monument")

This seems to align with the provided image. I also found the camera that streams this street!

![Image 4 Camera](/posts/tryhackme-geolocatingimages/image-4-camera.png "Image 4 Camera")
