...
![people-with-jackets](/assets/img/posts/osint-exercises/009/tirana-jackets.png)
_People with jackets_
...
_Tall building from the video_
...
![google-image-search](/assets/img/posts/osint-exercises/009/google-image-search.png)
...
![other-building](/assets/img/posts/osint-exercises/009/other-building.png)
_Other building_

Additionally, here's satellite imagery of the area that looks similar to the video:

![satellite-imagery](/assets/img/posts/osint-exercises/009/satellite-imagery.png)
_Satellite imagery + Google's 3D rendering_
